...
# while(cap.isOpened()):
#     ret, frame = cap.read()
#     img33 = vid_pipeline(frame)[0]
#     #print("left 1:")
#     #print((vid_pipeline(frame)[1])[0][50]) #  y : index 작을수록 본넷에 붙어있는거임.  x: index 클수록 본넷에 붙어있는거임811 
#     #print(lefty, leftx)
#     #print("right 1:")
#     #print((vid_pipeline(frame)[2])[0][50])
#     #print(righty, rightx)
    
    
#     cv2.imshow("result", img33)
